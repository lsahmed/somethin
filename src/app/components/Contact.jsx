  ...
  return (
    <div className="bg-[#464852] min-h-screen py-20 flex flex-col justify-center">
      <div className="max-w-5xl mx-auto px-6">
        ...
        {/* Contact Options */}
        <div className="flex flex-col md:flex-row md:justify-between md:items-start items-center gap-12 md:gap-0 mb-10">
          {/* Email */}
          <div className="flex flex-col items-center text-center md:text-left md:items-start">
            ...
            <a href="mailto:robobharattechnologies@gmail.com" className="text-gray-300 underline font-medium break-all">
          ...
          <div className="flex flex-col items-center text-center md:text-left md:items-start">
            ...
            <div className="text-gray-300">
              <a href="https://www.instagram.com/robobharattechnologies" target="_blank" rel="noopener noreferrer" className="break-all">
                @robobharattechnologies
              </a>
            </div>
          </div>
          {/* Address + Map */}
          <div className="flex flex-col items-center text-center md:text-left md:items-start w-full md:w-auto">
            <svg className="w-12 h-12 mb-3 text-gray-200" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 48 48">
            ...
            <div className="text-gray-300 mb-3">Delhi, India</div>
            ...
            <a
              ...
              className="block rounded-lg overflow-hidden border-2 border-gray-400 hover:shadow-lg transition w-full max-w-4xl"
            >
              <div className="relative" style={{ paddingTop: '50%' /* Adjusted for a wider map */ }}>
                <iframe
